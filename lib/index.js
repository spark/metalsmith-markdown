...
renderer.heading = function (text, level) {
  ...
  var count = 0;
  if (escapedText in headingCount) {
    count = headingCount[escapedText];
  }
  ...
  var header = '<h' + level + ' id="'+ escapedText +'">'+ text +'<a href="#' + escapedText + '" class="header-permalinks"><i class="ion-link"></i></a></h' + level + '>';
