...
renderer.heading = function (text, level) {
  ...
  var header = '<h' + level + ' id="#'+ escapedText +'" data-href="'+escapedPlusRandom+'">'+ text +'<a class="header-permalinks" data-menu-href="'+escapedPlusRandom+'"><i class="ion-link"></i></a></h' + level + '>';
